...
def create_empty_files():
    """Створює три порожніх файлу"""
    filenames = ['Молька1.txt', 'Молька2.txt', 'Молька3.txt']
...
def encrypt_decrypt_file(is_encrypt):
    ...
    file1_path = filedialog.askopenfilename(title="Виберіть Прізвище1.txt", filetypes=[("Text files", "*.txt")])
    file2_path = filedialog.askopenfilename(title="Виберіть Прізвище2.txt", filetypes=[("Text files", "*.txt")])
